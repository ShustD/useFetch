...
/* harmony export */   "delEditUser": () => (/* binding */ delEditUser)
/* harmony export */ });
const requestURL = 'https://jsonplaceholder.typicode.com/users'
const table = document.getElementById('tbody') 

function createRaw(element) {
...
function createTable() {
    ...
    .then(but => {
       function buttons() {
        ...
        Array.from(tr).forEach(function(trArray, index) {
          let buttonDel = createRaw('button');
          let td = createRaw('td');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "submitUsers": () => (/* binding */ submitUsers)
/* harmony export */ });
/* harmony import */ var _getUsers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);


const rft = document.getElementById('error')
const submit = document.getElementById("submit")
const nameUser = document.getElementById('name')
const phoneUser = document.getElementById('phone')
function errorLength (input) {
    const error = (0,_getUsers_js__WEBPACK_IMPORTED_MODULE_0__.createRaw)('div')
...
function createForm() {
        ...
        const buttonEd =(0,_getUsers_js__WEBPACK_IMPORTED_MODULE_0__.createRaw)('button');
        const buttonDel =(0,_getUsers_js__WEBPACK_IMPORTED_MODULE_0__.createRaw)('button');
        const buttonOk = (0,_getUsers_js__WEBPACK_IMPORTED_MODULE_0__.createRaw)('button')
        const tdEd = (0,_getUsers_js__WEBPACK_IMPORTED_MODULE_0__.createRaw)('td');
        const tdDel = (0,_getUsers_js__WEBPACK_IMPORTED_MODULE_0__.createRaw)('td');
            buttonEd.innerText = 'Edit user';
            buttonEd.className = 'btn_ed';
            buttonEd.id = 'ed'
            buttonDel.innerText = 'Delete user';
...
/* harmony import */ var _getUsers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
/* harmony import */ var _submitUsers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);




(0,_getUsers_js__WEBPACK_IMPORTED_MODULE_1__.createTable)()  
submit.addEventListener('click', _submitUsers_js__WEBPACK_IMPORTED_MODULE_2__.submitUsers)
table.addEventListener('click', _getUsers_js__WEBPACK_IMPORTED_MODULE_1__.delEditUser)
})();
